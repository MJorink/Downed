...
- Install [RagdollView](https://thunderstore.io/c/bonelab/p/Lakatrazz/RagdollView/) by Lakatrazz
- Make sure RagdollView is enabled in the bonemenu for the best experience
- !!! Set Ragdoll Player to arm control mode if you want to be able to crawl/use your arms while downed !!!

With this mod you get knocked down first instead of dying <br>
Ways to get revived while downed: <br>
- Being grabbed by another player for 5 seconds
- Using SDK mods, for example the [Signalis Auto Injector](https://mod.io/g/bonelab/m/auto-injector-signalis), you can also self-revive with this!
- Double-pressing the right joystick (manual force-revive)

While downed you will bleed out in 20 seconds, bleeding will pause while being grabbed. <br>
...
- When in a fusion gamemode that is not sandbox
...
this means you will have to double-press the right joystick, or get revived with an SDK mod like the Auto Injector to get up! <br>
...
## Credits
Spinny by Lakatrazz, I used the being grabbed check from the code. <br>
